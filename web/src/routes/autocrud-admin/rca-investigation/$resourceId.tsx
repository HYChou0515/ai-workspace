...
export const Route = createFileRoute('/autocrud-admin/rca-investigation/$resourceId')({
...
function DetailPage() {
  ...
  const navigate = useNavigate({ from: '/autocrud-admin/rca-investigation/$resourceId' });
  ...
  return (
    <ResourceDetail
      ...
      basePath="/autocrud-admin/rca-investigation"
