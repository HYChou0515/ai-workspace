...
export const Route = createFileRoute('/autocrud-admin/investigation/$resourceId')({
...
function DetailPage() {
  ...
  const navigate = useNavigate({ from: '/autocrud-admin/investigation/$resourceId' });

  const config = getResource('investigation')!;
  ...
  return (
    <ResourceDetail
      ...
      basePath="/autocrud-admin/investigation"
