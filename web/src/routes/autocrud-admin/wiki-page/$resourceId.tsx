...
export const Route = createFileRoute('/autocrud-admin/wiki-page/$resourceId')({
...
function DetailPage() {
  ...
  const navigate = useNavigate({ from: '/autocrud-admin/wiki-page/$resourceId' });
  ...
  return (
    <ResourceDetail
      ...
      basePath="/autocrud-admin/wiki-page"
