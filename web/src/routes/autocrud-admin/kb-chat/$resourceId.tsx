...
export const Route = createFileRoute('/autocrud-admin/kb-chat/$resourceId')({
...
function DetailPage() {
  ...
  const navigate = useNavigate({ from: '/autocrud-admin/kb-chat/$resourceId' });

  const config = getResource('kb-chat')!;
  ...
  return (
    <ResourceDetail
      ...
      basePath="/autocrud-admin/kb-chat"
