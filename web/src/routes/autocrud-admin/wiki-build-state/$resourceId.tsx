...
export const Route = createFileRoute('/autocrud-admin/wiki-build-state/$resourceId')({
...
function DetailPage() {
  ...
  const navigate = useNavigate({ from: '/autocrud-admin/wiki-build-state/$resourceId' });
  ...
  return (
    <ResourceDetail
      ...
      basePath="/autocrud-admin/wiki-build-state"
