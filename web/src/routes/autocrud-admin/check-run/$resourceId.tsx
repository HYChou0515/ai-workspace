...
export const Route = createFileRoute('/autocrud-admin/check-run/$resourceId')({
...
function DetailPage() {
  ...
  const navigate = useNavigate({ from: '/autocrud-admin/check-run/$resourceId' });

  const config = getResource('check-run')!;
  ...
  return (
    <ResourceDetail
      ...
      basePath="/autocrud-admin/check-run"
