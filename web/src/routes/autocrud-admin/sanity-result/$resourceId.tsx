...
export const Route = createFileRoute('/autocrud-admin/sanity-result/$resourceId')({
...
function DetailPage() {
  ...
  const navigate = useNavigate({ from: '/autocrud-admin/sanity-result/$resourceId' });
  ...
  return (
    <ResourceDetail
      ...
      basePath="/autocrud-admin/sanity-result"
