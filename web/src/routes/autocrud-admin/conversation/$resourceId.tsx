...
export const Route = createFileRoute('/autocrud-admin/conversation/$resourceId')({
...
function DetailPage() {
  ...
  const navigate = useNavigate({ from: '/autocrud-admin/conversation/$resourceId' });
  ...
  return (
    <ResourceDetail
      ...
      basePath="/autocrud-admin/conversation"
