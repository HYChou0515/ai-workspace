...
import { EMPTY_LOG, type AgentLog, logFromMessages } from "../pages/investigation/agentLog";
...
export type ChatLogState = {
  ...
  /** Replace the log with the persisted thread (`null` → empty). */
