...
export const messages = {
  ...
  "export.video.result": {
    "zh-TW": "{w}×{h}・文字 {s}×・最多約 {mb} MB",
    en: "{w}×{h} · text {s}× · up to about {mb} MB",
  },
  "export.video.tooBig": {
  ...
  "export.video.streamMs": { "zh-TW": "回覆（毫秒／字）", en: "Reply (ms per character)" },
  "export.video.toolPauseMs": { "zh-TW": "工具停頓（毫秒）", en: "Tool pause (ms)" },
