...
export const messages = {
  ...
  //
  // "the workspace reopens as you left it" stood here and was FALSE. The
  // mirror's `DEFAULT_IGNORES` drops `node_modules/`, `.venv/`, `__pycache__/`
  // and `.git/` — derived or huge, deliberately not persisted — so a recycled
  // sandbox comes back with the source and the lockfile and no dependencies
  // (`api/wui_routes.py` says exactly that, in those words). The person this
  // sentence is written for is the one hesitating over Close having just run
  ...
  "review.col.item": { "zh-TW": "項目", en: "Item" },
  "review.col.type": { "zh-TW": "類型", en: "Type" },
  "review.col.collection": { "zh-TW": "知識庫", en: "Knowledge base" },
  "review.col.run": { "zh-TW": "批次", en: "Run" },
  "review.col.status": { "zh-TW": "狀態", en: "Status" },
  "review.col.actions": { "zh-TW": "操作", en: "Actions" },
  "review.status.pending": { "zh-TW": "待決定", en: "Pending" },
  "review.status.accepted": { "zh-TW": "已接受", en: "Accepted" },
  "review.status.rejected": { "zh-TW": "已拒絕", en: "Rejected" },
  "review.status.committed": { "zh-TW": "已套用", en: "Applied" },
  "review.status.open": { "zh-TW": "待回答", en: "Open" },
  "review.status.answered": { "zh-TW": "已回答", en: "Answered" },
  "review.status.discarded": { "zh-TW": "已丟棄", en: "Discarded" },
  "review.action.accept": { "zh-TW": "接受", en: "Accept" },
  "review.action.reject": { "zh-TW": "拒絕", en: "Reject" },
  ...
  "review.readonly.hint": {
    ...
    en: "You can only view this knowledge base — you can't apply or answer here.",
  },
  "review.run.count": { "zh-TW": "{n} 張卡片提案", en: "{n} card proposals" },
  "review.selected": { "zh-TW": "已選取 {n}", en: "{n} selected" },
  "review.uncertain": { "zh-TW": "不確定", en: "Uncertain" },
  ...
  "review.applied.tally": {
    "zh-TW": "已建立 {created} · 更新 {updated} · 略過 {skipped}",
    en: "created {created} · updated {updated} · skipped {skipped}",
  },
  "review.badge.tip": { "zh-TW": "{n} 項待審核", en: "{n} items to review" },
  ...
  "todos.collapse": { "zh-TW": "收合", en: "Hide" },
  "todos.add": { "zh-TW": "新增", en: "Add" },
  "todos.add.placeholder": { "zh-TW": "新增待辦…", en: "Add a to-do…" },
  "todos.remove": { "zh-TW": "刪除這項", en: "Remove this item" },
  ...
  "export.range.latest": { "zh-TW": "最近", en: "Latest" },
  "export.range.latestUnit": { "zh-TW": "則", en: "messages" },
  "export.range.custom": { "zh-TW": "自訂", en: "Custom" },
  "export.range.from": { "zh-TW": "從", en: "From" },
  "export.range.to": { "zh-TW": "到", en: "To" },
  "export.range.note": {
    "zh-TW": "從最新往回數：1 是最新的一則。",
    en: "Counted from the newest: 1 is the latest message.",
  },
  "export.range.newest": { "zh-TW": "最新", en: "newest" },
  "export.range.oldest": { "zh-TW": "最舊", en: "oldest" },
  "export.video.format": { "zh-TW": "影片格式", en: "Video format" },
  "export.video.theme": { "zh-TW": "主題", en: "Theme" },
  ...
  "export.video.textSize": { "zh-TW": "文字大小", en: "Text size" },
  "export.video.textSize.auto": { "zh-TW": "自動", en: "Automatic" },
  "export.video.textSize.small": { "zh-TW": "小", en: "Small" },
  "export.video.textSize.medium": { "zh-TW": "中", en: "Medium" },
  "export.video.textSize.large": { "zh-TW": "大", en: "Large" },
  "export.video.textSize.xlarge": { "zh-TW": "特大", en: "Extra large" },
  "export.video.width": { "zh-TW": "寬", en: "Width" },
  "export.video.height": { "zh-TW": "高", en: "Height" },
  "export.video.result": {
    "zh-TW": "{w}×{h}・文字 {s}×・約 {mb} MB",
    en: "{w}×{h} · text {s}× · about {mb} MB",
  },
  "export.video.tooBig": {
    "zh-TW": "超過這個部署的上限（最多 {w}×{h} 的像素數）。",
  ...
  "export.video.maxSeconds.note": {
    "zh-TW": "這個部署最多 {n} 秒；更長的對話會被等比壓縮進去。",
    en: "This deployment allows up to {n} s; a longer conversation is compressed to fit.",
  },
  "export.submit.text": { "zh-TW": "下載", en: "Download" },
