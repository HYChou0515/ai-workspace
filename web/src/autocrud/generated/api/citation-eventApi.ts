...
const BASE = '/citation-event';

export const citationEventApi = {
  create: (data: CitationEvent) =>
    client.post<RevisionInfo>(BASE, data),

  list: (params?: SearchParams & { returns?: string }) =>
    client.get<FullResource<CitationEvent>[]>(BASE, { params }),
  ...
  get: (id: string, params?: { revision_id?: string; partial?: string[]; returns?: string; include_deleted?: boolean }) =>
    client.get<FullResource<CitationEvent>>(`${BASE}/${id}`, { params }),

  update: (id: string, data: CitationEvent, params?: { change_status?: string; mode?: string }) =>
