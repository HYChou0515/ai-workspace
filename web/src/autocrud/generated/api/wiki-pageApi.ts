...
export const wikiPageApi = {
  ...
  get: (id: string, params?: { revision_id?: string; partial?: string[]; returns?: string; include_deleted?: boolean }) =>
    client.get<FullResource<WikiPage>>(`${BASE}/${id}`, { params }),

  update: (id: string, data: WikiPage, params?: { change_status?: string; mode?: string }) =>
