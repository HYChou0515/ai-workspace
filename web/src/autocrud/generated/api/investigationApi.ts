...
export const investigationApi = {
  ...
  list: (params?: SearchParams & { returns?: string }) =>
    client.get<FullResource<Investigation>[]>(BASE, { params }),
  ...
  get: (id: string, params?: { revision_id?: string; partial?: string[]; returns?: string; include_deleted?: boolean }) =>
    client.get<FullResource<Investigation>>(`${BASE}/${id}`, { params }),

  update: (id: string, data: Investigation, params?: { change_status?: string; mode?: string }) =>
