...
export const sourceDocApi = {
  create: (data: SourceDoc) =>
    client.post<RevisionInfo>(BASE, data),

  list: (params?: SearchParams & { returns?: string }) =>
    client.get<FullResource<SourceDoc>[]>(BASE, { params }),
  ...
  get: (id: string, params?: { revision_id?: string; partial?: string[]; returns?: string; include_deleted?: boolean }) =>
    client.get<FullResource<SourceDoc>>(`${BASE}/${id}`, { params }),

  update: (id: string, data: SourceDoc, params?: { change_status?: string; mode?: string }) =>
