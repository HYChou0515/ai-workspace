...
export const notificationApi = {
  ...
  list: (params?: SearchParams & { returns?: string }) =>
    client.get<FullResource<Notification>[]>(BASE, { params }),
  ...
  get: (id: string, params?: { revision_id?: string; partial?: string[]; returns?: string; include_deleted?: boolean }) =>
    client.get<FullResource<Notification>>(`${BASE}/${id}`, { params }),

  update: (id: string, data: Notification, params?: { change_status?: string; mode?: string }) =>
