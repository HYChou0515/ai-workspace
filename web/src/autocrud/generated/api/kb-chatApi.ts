...
export const kbChatApi = {
  ...
  list: (params?: SearchParams & { returns?: string }) =>
    client.get<FullResource<KbChat>[]>(BASE, { params }),
  ...
  get: (id: string, params?: { revision_id?: string; partial?: string[]; returns?: string; include_deleted?: boolean }) =>
    client.get<FullResource<KbChat>>(`${BASE}/${id}`, { params }),

  update: (id: string, data: KbChat, params?: { change_status?: string; mode?: string }) =>
