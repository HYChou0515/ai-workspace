...
export const rcaInvestigationApi = {
  ...
  get: (id: string, params?: { revision_id?: string; partial?: string[]; returns?: string; include_deleted?: boolean }) =>
    client.get<FullResource<RcaInvestigation>>(`${BASE}/${id}`, { params }),

  update: (id: string, data: RcaInvestigation, params?: { change_status?: string; mode?: string }) =>
