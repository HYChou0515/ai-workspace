...
export const checkRunApi = {
  ...
  get: (id: string, params?: { revision_id?: string; partial?: string[]; returns?: string; include_deleted?: boolean }) =>
    client.get<FullResource<CheckRun>>(`${BASE}/${id}`, { params }),

  update: (id: string, data: CheckRun, params?: { change_status?: string; mode?: string }) =>
