...
const BASE = '/doc-chunk';

export const docChunkApi = {
  create: (data: DocChunk) =>
    client.post<RevisionInfo>(BASE, data),

  list: (params?: SearchParams & { returns?: string }) =>
    client.get<FullResource<DocChunk>[]>(BASE, { params }),
  ...
  get: (id: string, params?: { revision_id?: string; partial?: string[]; returns?: string; include_deleted?: boolean }) =>
    client.get<FullResource<DocChunk>>(`${BASE}/${id}`, { params }),

  update: (id: string, data: DocChunk, params?: { change_status?: string; mode?: string }) =>
