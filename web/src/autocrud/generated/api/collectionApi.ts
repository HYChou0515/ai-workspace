...
export const collectionApi = {
  ...
  list: (params?: SearchParams & { returns?: string }) =>
    client.get<FullResource<Collection>[]>(BASE, { params }),
  ...
  get: (id: string, params?: { revision_id?: string; partial?: string[]; returns?: string; include_deleted?: boolean }) =>
    client.get<FullResource<Collection>>(`${BASE}/${id}`, { params }),

  update: (id: string, data: Collection, params?: { change_status?: string; mode?: string }) =>
