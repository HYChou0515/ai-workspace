...
export const conversationApi = {
  ...
  list: (params?: SearchParams & { returns?: string }) =>
    client.get<FullResource<Conversation>[]>(BASE, { params }),
  ...
  get: (id: string, params?: { revision_id?: string; partial?: string[]; returns?: string; include_deleted?: boolean }) =>
    client.get<FullResource<Conversation>>(`${BASE}/${id}`, { params }),

  update: (id: string, data: Conversation, params?: { change_status?: string; mode?: string }) =>
