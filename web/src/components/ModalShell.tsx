    ...
    >
      <div
        ...
        style={{
          ...
          // drew their title against the border; 20 is what most callers
          // chose, and a caller that wants otherwise — including a deliberate
          // 0 for an edge-to-edge body — still says so in `panelStyle`.
          padding: 20,
          ...panelStyle,
        }}
      >
