...
Wires the defaults from grill-me:
  - LocalProcessSandbox (works in any VM/devcontainer without docker)
  - SpecstarFileStore (lightweight, in-process specstar with default config)
  - LitellmAgentRunner (Ollama qwen2.5-coder by default; requires Ollama)
  - SPA at web/dist if built

Override any of the four pieces by importing `workspace_app.api.create_app`
