...
| 檔案 | 內容 |
|---|---|
| `team-onboarding.md` | 給小組成員的平台導覽。**主檔 6 頁**（使命 / 架構 ①②③ / 未來 = 要建什麼 / 下一步 = 這一季誰動、怎麼驗收）＋ **附錄 11 頁**（回合資料流、fan-in queue、**固化階梯 → 兩種 tool → 四者的取捨** 三頁連著讀、Sandbox×FileStore、KB 進出、四道安全閘、可靠性、品質關卡） |
